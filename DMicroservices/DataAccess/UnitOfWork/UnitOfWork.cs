...
namespace DMicroservices.DataAccess.UnitOfWork
{
    ...
    public class UnitOfWork : IDisposable, IUnitOfWork
    {
        ...
        /// UnitOfWork başlangıcı 
        /// </summary>
        public UnitOfWork(Type dbContextType)
        {
        ...
        /// UnitOfWork başlangıcı 
        /// </summary>
        public UnitOfWork(string filterPropertyName, object filterPropertyValue, Type dbContextType)
        {
            DbContextType = dbContextType;
            filteredRepository = true;
            FilterColumnName = filterPropertyName;
        ...
        /// UnitOfWork başlangıcı 
        /// </summary>
        public UnitOfWork(string filterPropertyName, object filterPropertyValue, UnitOfWorkSettings unitOfWorkSettings, Type dbContextType)
        {
            DbContextType = dbContextType;
            filteredRepository = true;
            FilterColumnName = filterPropertyName;
        ...
        public int SaveChanges()
        {
            ...
            finally
            {
                ...
                {
                    ElasticLogger.Instance.Info(
                        $"UnitOfWork Save Error. Type : {DbContextType.Name} Error Messages : {JsonConvert.SerializeObject(ErrorMessageList)}");
                }
            }
